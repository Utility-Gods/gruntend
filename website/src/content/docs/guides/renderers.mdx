...
<Aside type="caution" title="Separate security boundaries">
  DOMPurify sanitizes generated markup. It does not isolate generated JavaScript
  or reduce the authority of registered tool handlers. Select the executor trust
  boundary independently and always authorize operations inside
